...
/*Importing the precompile configuration for the port module*/
#include "Port_Cfg.h"

/* Checking the Autosar Version between the preconfiguration file and the header file of the port module */
...
/* Checking the Software Version between the preconfiguration file and the header file of the port module  */
